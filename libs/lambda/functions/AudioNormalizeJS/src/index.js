...
exports.handler = function (eventObject, context) {
	...
	return s3Util.downloadFileFromS3(inputBucket, inputFile, localInputFile)
		.then(() => childProcessPromise.spawn(
			'/opt/bin/ffmpeg',
			['-loglevel', 'error', '-y', '-i', localInputFile, '-vcodec', 'libx264', '-filter:v', 'scale=-1:920', '-preset', 'medium', '-codec:a', 'aac', '-strict', 'experimental', '-af', 'highpass=200, lowpass=1500, loudnorm=I=-35:TP=-1.5:LRA=20', '-threads', '0', localOutputFile],
