...
var CommandFactory = /** @class */ (function () {
    ...
    CommandFactory.measure = function (_a) {
        ...
        var command = "/opt/bin/ffmpeg" + " -hide_banner ";
        command += "-i \"" + input + "\" ";
        command += "-af loudnorm=";
    ...
    CommandFactory.getDuration = function (input) {
        var command = "/opt/bin/ffmpeg" + " -hide_banner -i \"" + input + "\" -f null -";
        return new Command({
            text: command,
            processAfter: function (_a) {
                var stderr = _a.stderr;
...
var Normalizer = /** @class */ (function () {
    ...
    Normalizer.fileHasAudio = function (input) {
        return new Promise(function (resolve) {
            try {
                var command = new Command({ text: "/opt/bin/ffprobe" + " -i \"" + input + "\" -show_streams -select_streams a -loglevel error" });
                command.execute({
                    success: function (_a) {
