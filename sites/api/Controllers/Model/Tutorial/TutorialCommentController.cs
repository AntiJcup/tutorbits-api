...
namespace api.Controllers.Model
{
    ...
    [ApiController]
    public class TutorialCommentController : BaseCommentController<TutorialComment, CreateTutorialCommentModel, UpdateTutorialCommentModel, TutorialCommentViewModel>
    {
